      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-white text-xl font-bold mb-4">EssayBridge</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/essays" className="hover:text-primary-400 transition-colors">
                  논술 첨삭
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/consulting" className="hover:text-primary-400 transition-colors">
                  입시 컨설팅
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/guide" className="hover:text-primary-400 transition-colors">
                  이용 가이드
                </Link>
              </li>
              <li>
                <Link to="/notice" className="hover:text-primary-400 transition-colors">
                  공지사항
                </Link>
              </li>
              <li>
